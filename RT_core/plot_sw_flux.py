...
plt.plot(fs1/fs1[0],p1,label='16+16 EE',c=col[0],ls='dotted')
plt.plot(fs2/fs2[0],p2,label='4+4 RORR',c=col[1])
plt.plot(fs3/fs3[0],p3,label='8+8 RORR',c=col[2])
plt.plot(fs4/fs4[0],p4,label='16+16 RORR',c='black')
plt.plot(fs5/fs5[0],p5,label='16+16 PRAS (100)',ls='dashed',c=col[3])
plt.plot(fs6/fs6[0],p6,label='16+16 PRAS (1000)',ls='dashed',c=col[4])
plt.plot(fs7/fs7[0],p7,label='16+16 PRAS (10000)',ls='dashed',c=col[7])

x1, x2, y1, y2 = 0.5, 0.8, 1e-1, 1e-2  # subregion of the original image
axins = ax.inset_axes(
    [0.2, 0.6, 0.6, 0.3],
...
axins.plot(fs1/fs1[0],p1,c=col[0],ls='dotted')
axins.plot(fs2/fs2[0],p2,c=col[1])
axins.plot(fs3/fs3[0],p3,c=col[2])
axins.plot(fs4/fs4[0],p4,c='black')
axins.plot(fs5/fs5[0],p5,ls='dashed',c=col[3])
axins.plot(fs6/fs6[0],p6,ls='dashed',c=col[4])
axins.plot(fs7/fs7[0],p7,ls='dashed',c=col[7])

#ax.indicate_inset_zoom(axins, edgecolor="black")

plt.xlabel(r'$F_{\rm x}$/$F_{\rm TOA}$',fontsize=16)
...
plt.savefig('sw_flux.pdf',dpi=300,bbox_inches='tight')
...
plt.savefig('sw_heat.pdf',dpi=300,bbox_inches='tight')
